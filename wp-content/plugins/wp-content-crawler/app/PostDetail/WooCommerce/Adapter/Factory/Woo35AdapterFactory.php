...
use WPCCrawler\PostDetail\WooCommerce\Adapter\Woo35\Woo35ExternalProductAdapter;
use WPCCrawler\PostDetail\WooCommerce\Adapter\Woo35\Woo35SimpleProductAdapter;

class Woo35AdapterFactory extends BaseWooAdapterFactory {
    ...
    public function createSimpleProductAdapter($simpleProduct) {
        return new Woo35SimpleProductAdapter($simpleProduct);
    }
    ...
    public function createExternalProductAdapter($externalProduct) {
        return new Woo35ExternalProductAdapter($externalProduct);
    }
