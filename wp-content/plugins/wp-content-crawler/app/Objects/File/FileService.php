...
class FileService {
    ...
    public function saveMediaFile(MediaFile $mediaFile, PostBot $postBot) {
        // Save the file
        $file = MediaService::getInstance()->saveMedia($mediaFile->getSourceUrl(), $postBot->getSetting("_wpcc_http_user_agent", null));
         ...
         * @return array
         */
        $file = apply_filters('wpcc/post/media/file', $file, $mediaFile->getSourceUrl(), $postBot->getPostUrl(), $postBot->getSiteId(), $this);
