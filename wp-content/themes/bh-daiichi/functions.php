...
if ( ! function_exists( 'bh_daiichi_setup' ) ) {
	/**
...
if ( ! function_exists( 'bh_daiichi_scripts_styles' ) ) {
	/**
...
add_action( 'wp_enqueue_scripts', 'bh_daiichi_scripts_styles' );

if ( ! function_exists( 'bh_daiichi_register_elementor_locations' ) ) {
	/**
...
add_action( 'elementor/theme/register_locations', 'bh_daiichi_register_elementor_locations' );

if ( ! function_exists( 'bh_daiichi_content_width' ) ) {
	/**
	 * Set default content width.
	 *
	 * @return void
	 */
	function bh_daiichi_content_width() {
		$GLOBALS['content_width'] = apply_filters( 'bh_daiichi_content_width', 800 );
	}
}
add_action( 'after_setup_theme', 'bh_daiichi_content_width', 0 );
...
if ( ! function_exists( 'bh_daiichi_check_hide_title' ) ) {
	 ...
	 * @return bool
	 */
	function bh_daiichi_check_hide_title( $val ) {
...
add_filter( 'bh_daiichi_page_title', 'bh_daiichi_check_hide_title' );

/**
 * Wrapper function to deal with backwards compatibility.
 */
if ( ! function_exists( 'bh_daiichi_body_open' ) ) {
	function bh_daiichi_body_open() {
